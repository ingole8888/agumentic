...
export default function LargeWithNewsletter() {
  return (
    <Box
      ...
      marginTop={"100px"}
      >
      <Container as={Stack} maxW={'8xl'} py={10} marginRight={"20px"}>
        <SimpleGrid
          templateColumns={{ sm: '1fr 1fr', md: '1fr 1fr 1fr 1fr', lg: '1fr 1fr 1fr 1fr 1fr 1fr' }}
          fontSize={"20px"}
          ...
          <Stack align={'flex-start'}>
            <ListHeader color={"black"}>For designers</ListHeader>
          ...
          <Stack align={'flex-start'}>
            <ListHeader color={"black"}>Hire designers</ListHeader>
            <Link href={'#'}>Help Center</Link>
            <Link href={'#'}>Terms of Service</Link>
            <Link href={'#'}>Legal</Link>
            <Link href={'#'}>Privacy Policy</Link>
            <Link href={'#'}>Satus</Link>
            <ListHeader color={"black"}>Brands</ListHeader>
            <Link href={'#'}>Help Center</Link>
            <Link href={'#'}>Terms of Service</Link>
            <Link href={'#'}>Legal</Link>
            <Link href={'#'}>Privacy Policy</Link>
          ...
          <Stack align={'flex-start'}>
            <ListHeader color={"black"}>Directories</ListHeader>
            <Link href={'#'}>Help Center</Link>
            <Link href={'#'}>Terms of Service</Link>
            <Link href={'#'}>Legal</Link>
            <Link href={'#'}>Privacy Policy</Link>
            <Link href={'#'}>Satus</Link>
            <ListHeader color={"black"}>Design Assets</ListHeader>
            <Link href={'#'}>Help Center</Link>
            <Link href={'#'}>Terms of Service</Link>
            <Link href={'#'}>Legal</Link>
            <Link href={'#'}>Privacy Policy</Link>
          ...
          <Stack align={'flex-start'}>
            <ListHeader color={"black"}>Design Resorces</ListHeader>
            <Link href={'#'}>Help Center</Link>
            <Link href={'#'}>Terms of Service</Link>
            <Link href={'#'}>Legal</Link>
            <Link href={'#'}>Privacy Policy</Link>
